...
from sayplan.shared_kernel.infra.database.sqla import Base
from sayplan.shared_kernel.infra.database.sqla.mixin import TimestampMixin


class LeaderBoardLog(Base, TimestampMixin):
    __tablename__ = "sayplan_leaderboard_log"
